...
python3 formatting/s4_adjust_weights.py --index-diachron index-diachronica/output/index_diachronica_unicode_4.6 --in-graph-pkl phone_graph.pkl --out-graph-pkl phone_graph.pkl
